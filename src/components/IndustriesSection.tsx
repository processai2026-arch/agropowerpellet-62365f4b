...
const IndustriesSection = () => {
  return (
    <section id="industries" className="py-20 md:py-28 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((ind) => (
            <div
              key={ind.name}
              className="bg-card rounded-2xl p-6 border border-border hover:border-primary/40 transition-all text-center group"
            >
